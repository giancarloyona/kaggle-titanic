"""
    ...
    This model will use the Random Forest Classifier to generate the results.
...
regressor = RandomForestClassifier(n_estimators = 500, criterion = 'entropy', random_state = 0)
...
results.to_csv('./results_rfc.csv', sep = ',', index = False)